...
runGA <- function(noRuns = 30, problem = "feature", popSize = 15, pcrossover = 0.2, pmutation = 0.6) {
...
results2 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pcrossover = 0.2, pmutation = 0.5)
results3 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pcrossover = 0.2, pmutation = 0.8)